...
const updateMentorRatings = async (messageId, ratings, studentName) => {
    ...
    if(studentArray.length > 0)
    {
        ...
        console.log("runningAverageRatings", runningAverageRatings);
        console.log("newNoOfRatings", newNoOfRatings);
